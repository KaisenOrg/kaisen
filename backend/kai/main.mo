...
actor {
  ...
  public func askGemini(prompt : Text) : async Text {
    ...
    let url = "https://generativelanguage.googleapis.com/v1beta/models/gemini-2.0-flash:generateContent?key=AIzaSyBxFFROTUdcOjNHw4h15Qx5Nwh9ITCZpD8"; //HTTP that accepts IPV6
    ...
    // Adicionamos \" antes de # prompt #
    let request_body_json : Text = "{\"contents\": [{\"parts\": [{\"text\": \"" # prompt # "\"}]}]}";
