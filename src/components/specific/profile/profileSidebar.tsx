...
const LinkProfile = ({href, title, Icon} : LinkProfileProps) => {
    return(
        <Link href={href} className="group px-2 py-3 flex items-center justify-between w-full rounded-none first:rounded-t-xl last:rounded-b-xl transition-colors duration-200 hover:bg-orange-500/5 hover:text-white hover:text-bold hover:border-l hover:border-orange-500">
