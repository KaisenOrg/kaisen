...
export default function SettingsPage() {
  ...
  const [avatarInitials] = useState("CN"); // Replace with user initials if available
      ...
      <div className="flex flex-col md:flex-row md:items-start gap-8">
        <form className="flex-1 space-y-6 text-zinc-400">
          <div className="flex gap-8">
            <div className="flex flex-col w-full gap-8">
              <div>
                ...
                <Input id="fullName" placeholder="Placeholder" className="bg-zinc-900 border-zinc-800" />
              </div>
              <div>
                <label htmlFor="displayName" className="block text-sm font-medium mb-1">Display name</label>
                <Input id="displayName" placeholder="Placeholder" className="bg-zinc-900 border-zinc-800" />
              </div>
            </div>
          ...
          <div>
            ...
            <Input id="whatDoYouDo" placeholder="Placeholder" className="bg-zinc-900 border-zinc-800" />
          </div>
          <div>
            <label htmlFor="aboutMe" className="block text-sm font-medium mb-1">About me</label>
            <Textarea id="aboutMe" placeholder="Placeholder" className="bg-zinc-900 border-zinc-800 min-h-[96px]" />
          </div>
